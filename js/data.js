    ...
    cookingTips: [
      {
        category: '切菜', icon: '🔪', records: [
          { title: '西兰花', md: '尽量沿着茎一起切，根部要切掉。\n\n切掉一半，切小了可以用手掰。' },
          { title: '胡萝卜', md: '切之前要去头。可以切成 1/2 或者切成 1/4，再去进行切片。\n\n切片的时候尽量先竖着切片，然后再横着切，把它切小。' }
        ]
      },
      {
        category: '烘焙', icon: '🍞', records: [
          { title: '酵母选择', md: '新手建议用 **干酵母**，不要用鲜酵母。鲜酵母不好掌控用量，容易翻车。' },
          { title: '夏天打面顺序', md: '夏天发酵速度快，发酵太快会导致面包中间塌掉、支撑不起来。打面时先放盐，揉出粗膜；再放黄油和酵母，揉出手套膜。' },
          { title: '发酵流程', md: '分割面团 → 一发 → 做造型、包馅料 → 二发 → 挤酱 / 刷黄油 → 进烤箱。' },
          { title: '海盐卷', md: '进烤箱前如果刷了蛋液，记得喷一层水，否则上火太高表面容易糊。\n\n出炉后刷一层融化好的黄油，皮特别香。' }
        ]
      },
      {
        category: '烹煮', icon: '🍲', records: [
          { title: '饺子的煮法', md: '**煮饺子步骤：**\n\n1. 冷水下锅，同时把饺子放进去。\n2. 大火煮沸，等水面冒泡、沸腾后调小火，让水面处于“有动静但没完全沸腾”的状态，直到饺子全部上浮。\n3. 加一点点冷水，让饺子慢慢变成透明态，然后捞起。\n\n**蘸料配方：**\n\n- 1:1 的酱油和陈醋（按个人口味调整）\n- 1/3 的香油（以酱油 + 陈醋总量为基准）\n- 1/4 勺盐、味精、糖\n- 按上述比例混合即可。' }
        ]
      },
