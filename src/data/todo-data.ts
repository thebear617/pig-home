...
export const TODO_BOARDS: TodoBoard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'l32', title: '过马路去校医院看牙齿', status: 'todo', date: '2026-08-25', createdAt: '2026-08-25', url: '', note: '' },
      { id: 'l33', title: '过马路问学校的电脑多少钱', status: 'todo', date: '2026-08-25', createdAt: '2026-08-25', url: '', note: '' },
      { id: 'l34', title: '在家里买油瓶', status: 'todo', date: '2026-08-26', createdAt: '2026-08-25', url: '', note: '' },
    ]
  },
  {
    id: 'coding',
    ...
    items: [
      ...
      { id: 'c15', title: '参考 B 站视频美化自己的个人仪表盘，学习他的记笔记方式', status: 'todo', date: '2026-08-22', createdAt: '2026-08-16', url: 'https://lvyovo-wiki.tech/', note: '' },
