...
export const foodRecords: Record<string, FoodMeal[]> = {
  ...
  '2026-07-30': [
    { meal: '晚饭', shopping: 20, prep: 30, cleanup: 20, dishes: [
      '青菜火腿蛋炒饭'
    ], cost: 4 }
  ],
  '2026-08-25': [
    { meal: '中饭', prep: 20, cleanup: 10, chef: '过马路', dishes: [
      { name: '紫菜虾米馄饨', madeBy: '过马路' },
      { name: '牛排', madeBy: '过马路' }
    ]}
  ],
  '2026-08-27': [
    { meal: '晚饭', prep: 60, dishes: [
      '宫保鸡丁',
      '凉拌西兰花',
      '凉拌黄瓜胡萝卜'
    ]}
  ...
  '2026-08-30': [
    { meal: '晚饭', prep: 15, cook: 20, cleanup: 10, cost: 10, dishes: [
      { name: '香菇青菜', madeBy: '过马路' },
      { name: '青椒肉丝', madeBy: '耙耙柑' }
    ]}
  ],
  '2026-09-04': [
    { meal: '晚饭', prep: 30, cleanup: 10, chef: '耙耙柑', dishes: [
  ...
  '2026-09-08': [
    { meal: '晚饭', cost: 7.5, dishes: [
      { name: '牛排', madeBy: '过马路' },
      { name: '蒜蓉空心菜', madeBy: '过马路', cost: 1.5 },
      { name: '麻婆豆腐', madeBy: '耙耙柑', cost: 6 }
    ]}
  ],
  '2026-09-09': [
    { meal: '晚饭', prep: 25, cleanup: 15, dishes: [
      { name: '干煸豆角', madeBy: '过马路', cost: 3 },
      { name: '凉拌黄瓜', madeBy: '过马路', cost: 2 },
      { name: '青椒肉丝', madeBy: '耙耙柑', cost: 8 }
    ]}
  ],
  '2026-09-11': [
    { meal: '晚饭', prep: 25, cleanup: 20, dishes: [
      { name: '金钱蛋', madeBy: '过马路', cost: 4.5 },
      { name: '手撕包菜', madeBy: '耙耙柑', cost: 1.7 },
      { name: '牛排', madeBy: '过马路', note: '不计钱' }
    ]}
  ],
  '2026-09-22': [
    { meal: '晚饭', prep: 10, cleanup: 5, chef: '过马路', cost: 4, dishes: [
      { name: '咖喱拌面', madeBy: '过马路', cost: 4, note: '非常好吃' }
    ]}
  ]
};
